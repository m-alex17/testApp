...
android {
    namespace = "com.alex.testapp"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.alex.testapp"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    ksp(libs.androidx.room.compiler)  // Kotlin Symbol Processing (KSP) for Room
    ...
    implementation("androidx.lifecycle:lifecycle-livedata-ktx:2.6.2") // for asLiveData()
